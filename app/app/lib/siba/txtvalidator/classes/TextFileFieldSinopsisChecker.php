...
class TextFileFieldSinopsisChecker implements \Siba\txtvalidator\interfaces\FileDataFieldChecker {
    ...
    public function checkFieldIntegrity($field) {
        ...
        if (preg_match('/([\|&\"\'><'.chr(8).''.chr(9).''.chr(10).''.chr(13).''.chr(26).''.chr(133).''.chr(147).''.chr(148).''.chr(150).''.chr(151).''.chr(156).''.chr(157).''.chr(166).''.chr(171).''.chr(174).''.chr(187).''.chr(191).''.chr(226).']){1,100}/',$field,$matches)){
